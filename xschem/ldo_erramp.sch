...
N -100 -330 -100 -400 {lab=vin}
N -100 -400 140 -400 {lab=vin}
N 140 -400 140 -330 {lab=vin}
N -140 -300 -190 -300 {lab=n3}
N -190 -300 -190 -270 {lab=n3}
N -190 -270 -100 -270 {lab=n3}
N 100 -300 100 -250 {lab=n3}
N 100 -250 -100 -250 {lab=n3}
N -100 -250 -100 -270 {lab=n3}
N -100 -270 -100 -150 {lab=n3}
N 140 -270 140 -150 {lab=eout}
N -100 -90 -100 -40 {lab=ntail}
N -100 -40 140 -40 {lab=ntail}
N 140 -40 140 -90 {lab=ntail}
N 20 10 20 -40 {lab=ntail}
N 20 -40 -100 -40 {lab=ntail}
N -100 -40 -100 -90 {lab=ntail}
N 20 70 20 150 {lab=vss}
N 20 150 -300 150 {lab=vss}
N -300 150 -300 70 {lab=vss}
N -340 40 -390 40 {lab=ibias}
N -390 40 -390 10 {lab=ibias}
N -390 10 -300 10 {lab=ibias}
N -20 40 -20 -20 {lab=ibias}
N -20 -20 -300 -20 {lab=ibias}
N -300 -20 -300 10 {lab=ibias}
